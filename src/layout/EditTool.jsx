    ...
    return (
        <div className='container table my-5 pt-5 shadow  bg-light rounded-7'>
          <form>
            ...
            <div class="form-group row">
              <label for="inputUsernamel3" class="col-sm-2 col-form-label"><h6 class="text-black"><b>Units</b></h6></label>
              <div class="col-sm-10">
                <input type="username" 
                class="form-control" 
                id="inputUnit3" 
            ...
            <div class="form-group row my-5">
              {/* <div class="col-sm-10"> */}
              <div>
                <button type="submit" class="btn btn-danger mx-2" onClick={changestateCancel}><b>Cancel</b></button>
             
                <button type="submit" class="btn btn-primary mx-2" onClick={changestateAddTool}><b>Edit</b></button>
                {/* <ToastContainer /> */}
              </div>
            </div>
        </form>
