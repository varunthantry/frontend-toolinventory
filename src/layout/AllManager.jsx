...

                        {
                            data.filter((dat)=> {
                                if(searchTerm === "" && Role === dat.role){
                                    ...
                                    return dat
                                }else if(dat.id.toLowerCase().includes(searchTerm.toLowerCase()) && Role === dat.role) {
                                    return dat
                                }
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        >Edit</Link>
                                        <button className='btn btn-danger mx-2' onClick={() => deleteManager(dat?.id)}
                                        >Delete</button>
